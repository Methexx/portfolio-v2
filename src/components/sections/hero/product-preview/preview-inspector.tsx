...
export function PreviewInspector() {
  return (
    <aside className="hidden h-full min-h-0 flex-col bg-preview-inspector px-3 py-4 text-white/72 md:flex md:px-4 lg:px-5">
      ...
      <div className="mt-auto flex justify-end pt-4 text-white/34">
