...
export function AiDemoPanel() {
  return (
    <div className="relative overflow-hidden rounded-[2rem] border border-ai-panel-border bg-[radial-gradient(circle_at_top,rgba(151,115,255,0.18),transparent_30%),radial-gradient(circle_at_80%_28%,rgba(116,74,255,0.15),transparent_24%),linear-gradient(180deg,rgba(40,27,56,0.96),rgba(25,18,36,0.99))] p-5 shadow-[0_42px_80px_-48px_rgba(39,20,50,0.55)] sm:p-7 lg:p-8">
