...
type SecurityVisualProps = {
  accessPanelSlot?: ReactNode;
  centerPanelSlot?: ReactNode;
  className?: string;
  dataCardsSlot?: ReactNode;
  dataHeadingSlot?: ReactNode;
};
    ...
    >
      ...
      <div className="relative grid gap-5 lg:min-h-[38rem] lg:grid-cols-[0.3fr_0.4fr_0.3fr]">
        <div className="order-2 space-y-3 lg:order-1">
          ...
          {dataCardsSlot ??
            securityDataItems.map((item) => <SecurityDataCard key={item.id} item={item} />)}
        </div>
