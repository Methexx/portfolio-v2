...
import { researchReadingCopy } from "@/components/sections/research-reading/research-reading-data";

type ResearchReadingHeaderProps = {
  labelSlot?: ReactNode;
  headingSlot?: ReactNode;
  descriptionSlot?: ReactNode;
};

export function ResearchReadingHeader({
  labelSlot,
  headingSlot,
  descriptionSlot,
