...
export function MeetingDetailPanel() {
  ...
  return (
    <div className="rounded-[1.9rem] border border-meetings-border bg-meetings-panel p-4 shadow-[0_24px_60px_-42px_rgba(36,21,47,0.24),inset_0_1px_0_rgba(255,255,255,0.68)] sm:p-5 lg:p-6">
      ...
      <MeetingNotesPanel detail={detail} />
    </div>
  );
}
