...
export function MeetingList() {
  return (
    <div className="rounded-[1.7rem] border border-meetings-border bg-meetings-panel px-4 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.62)] sm:px-5">
      ...
      <div className="relative mt-4 space-y-3 pl-4">
        <div className="absolute bottom-2 left-1.5 top-2 w-px bg-meetings-timeline" />
